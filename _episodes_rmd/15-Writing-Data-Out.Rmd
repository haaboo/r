...
[data import]({{ page.root }}{% link _episodes/18-Additional-content---Reading-Data-In.md %}) lesson), there are various `write_XXX` functions to write data frames out in different formats. It is usually best to write 
